...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-p24-c30.mk dist/${CND_CONF}/${IMAGE_TYPE}/p24_free_rtos.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/fardo.o: fardo.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/fardo.o.ok ${OBJECTDIR}/fardo.o.err 
	@${FIXDEPS} "${OBJECTDIR}/fardo.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -I"." -I"./free_rtos" -I"./free_rtos/include" -I"./free_rtos/portable/MemMang" -I"./free_rtos/portable/MPLAB/PIC24_dsPIC" -I"./microchip" -I"./microchip/Common" -I"./microchip/Include" -I"./microchip/Include/USB" -I"./microchip/USB" -I"./microchip/TCPIP Stack" -I"./microchip/TCPIP Stack/WiFi" -I"./microchip/MDD File System" -I"./microchip/Include/TCPIP Stack" -I"./microchip/Include/MDD File System" -I"./mini_ini" -mlarge-code -O1 -fno-schedule-insns -fno-schedule-insns2 -MMD -MF "${OBJECTDIR}/fardo.o.d" -o ${OBJECTDIR}/fardo.o fardo.c   -fno-omit-frame-pointer
...
${OBJECTDIR}/v2.o: v2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/v2.o.d 
	@${RM} ${OBJECTDIR}/v2.o.ok ${OBJECTDIR}/v2.o.err 
	@${FIXDEPS} "${OBJECTDIR}/v2.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -I"." -I"./free_rtos" -I"./free_rtos/include" -I"./free_rtos/portable/MemMang" -I"./free_rtos/portable/MPLAB/PIC24_dsPIC" -I"./microchip" -I"./microchip/Common" -I"./microchip/Include" -I"./microchip/Include/USB" -I"./microchip/USB" -I"./microchip/TCPIP Stack" -I"./microchip/TCPIP Stack/WiFi" -I"./microchip/MDD File System" -I"./microchip/Include/TCPIP Stack" -I"./microchip/Include/MDD File System" -I"./mini_ini" -mlarge-code -O1 -fno-schedule-insns -fno-schedule-insns2 -MMD -MF "${OBJECTDIR}/v2.o.d" -o ${OBJECTDIR}/v2.o v2.c   -fno-omit-frame-pointer
...
dist/${CND_CONF}/${IMAGE_TYPE}/p24_free_rtos.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/p24_free_rtos.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}       -Wl,--defsym=__MPLAB_BUILD=1,--heap=6200$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/p24_free_rtos.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/p24_free_rtos.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}       -Wl,--defsym=__MPLAB_BUILD=1,--heap=6200$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
